const main = async () => {
  ...
  // like = await socialMediaContractFactory.like("2");
  // startTime = Date.now();
  ...
  //like userOne
  beforeSubmit = Date.now();
  like = await socialMediaContractFactory.connect(userOne).like("3");
  startTime = Date.now();
  await provider.waitForTransaction(like.hash, 1);
  transactionTime = Date.now() - startTime;
  submissionTime = Date.now() - beforeSubmit;
  ...
  //like userTwo
  beforeSubmit = Date.now();
  like = await socialMediaContractFactory.connect(userTwo).like("4");
  startTime = Date.now();
  await provider.waitForTransaction(like.hash, 1);
  transactionTime = Date.now() - startTime;
  submissionTime = Date.now() - beforeSubmit;
